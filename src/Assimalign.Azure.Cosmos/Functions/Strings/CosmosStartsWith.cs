...
namespace Assimalign.Azure.Cosmos.Functions
{
    ...
    /// 
    /// </summary>
    public sealed class CosmosStartsWith : ICosmosFunction
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public bool TryGetExpression(Expression parameter, out Expression expression)
        {
            ...
            var methodinfo = CosmosUtility.GetStartsWithMethod();
            ...
            else
            {
                throw new CosmosInvalidMethodRequestException(
                     ...
                     source: "The method '$startsWith' cannot be used for the requested member or method.");
            }
