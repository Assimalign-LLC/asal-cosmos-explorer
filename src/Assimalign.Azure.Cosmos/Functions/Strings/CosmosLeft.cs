...
namespace Assimalign.Azure.Cosmos.Functions
{
    ...
    /// 
    /// </summary>
    public sealed class CosmosLeft : CosmosFunctions, ICosmosFunction
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <summary>
        /// The number of characters to select from left of string.
        /// </summary>
        ...
        public bool TryGetExpression(Expression parameter, out Expression expression)
        {
            ...
            var arguments = CosmosUtility.GetArgumentExpressions(0, this.StringLength);
            ...
            else
            {
                throw new CosmosInvalidMethodRequestException(
                    ...
                    source: "The method '$left' cannot be used for the requested member or method.");
            }
