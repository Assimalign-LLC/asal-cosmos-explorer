...
namespace Assimalign.Azure.Cosmos.Clauses
{
    ...
    /// 
    /// </summary>
	public sealed class CosmosWhere : CosmosFunctions, ICosmosWhere<CosmosWhere>
	{
        ...
        /// <summary>
        /// A logical operator for applying all predicates to each statements.
        /// </summary>
        [JsonPropertyName("$and")]
        public IEnumerable<CosmosWhere> And { get; set; } = new List<CosmosWhere>();

        /// <summary>
        /// A logical operator for applying one or more predicates to either statements.
        /// </summary>
		[JsonPropertyName("$or")]
		public IEnumerable<CosmosWhere> Or { get; set; } = new List<CosmosWhere>();

        /// <summary>
        /// The string name of the property to apply filtering to.
        /// </summary>
        [JsonPropertyName("$property")]
		public string Property { get; set; }

        /// <summary>
        /// Reserved Functions that don't require embedded JSON objects to query.
        /// </summary>
        [JsonPropertyName("$function")]
        public ValueTypeFunctions Function { get; set; } = ValueTypeFunctions.None;
        ...
        public IOrderedQueryable<T> CreateQuery<T>(IQueryable<T> source)
        {
			...
			var where = Expression.Call(
					...
					source.Expression,
					lambda);
			return source.Provider.CreateQuery<T>(where) as IOrderedQueryable<T>;
		}
        ...
        /// <returns></returns>
        private Expression GetLambdaExpressionBody(CosmosWhere instance, Expression parameter)
        {
