...
namespace Assimalign.Azure.Cosmos.Functions
{
    ...
    /// 
    /// </summary>
    public sealed class CosmosTrimStart : CosmosFunctions, ICosmosFunction
    {

        /// <summary>
        /// The Character to trim from the start of the String Value.
        /// </summary>
        ...
        public bool TryGetExpression(Expression parameter, out Expression expression)
        {
            ...
            var methodinfo = CosmosUtility.GetTrimStartMethod();
            ...
            else
            {
                throw new CosmosInvalidMethodRequestException(
                     ...
                     source: "The method '$trimStart' cannot be used for the requested member or method.");
            }
